...
import manggo.com.bannerview.transformer.CoverModeTransformer;
import manggo.com.bannerview.transformer.ScaleYTransformer;
...
public class BannerView<T> extends RelativeLayout {
     ...
     * @param holderCreator  ViewHolder生成器 {@link HolderCreator} And {@link MViewHolder}
     */
    public void setPages(List<T> datas,HolderCreator holderCreator){
        ...
        mAdapter = new MZPagerAdapter(datas, holderCreator,mIsCanLoop);
    ...
    public static class  MZPagerAdapter<T> extends PagerAdapter{
        ...
        public MZPagerAdapter(List<T> datas, HolderCreator HolderCreator, boolean canLoop) {
            if(mDatas == null){
